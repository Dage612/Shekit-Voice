...
namespace HearMyVoiceConsole
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\Dage6\source\repos\HearMyVoice\HearMyVoiceConsole\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=23,MinimumExampleCountPerLeaf=12,NumberOfTrees=7,MaximumBinCountPerFeature=199,FeatureFraction=0.956148269587241,LearningRate=0.0942457272609289,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
